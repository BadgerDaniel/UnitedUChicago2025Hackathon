...
# =============================================================================
# Purpose:
# This file connects the FlightIntelligenceAgent to the task-handling system.
# =============================================================================
...
class FlightTaskManager(InMemoryTaskManager):
    """
    Task manager that connects the Flight Intelligence Agent to the A2A system.
    """

    def __init__(self):
        super().__init__()
        self.agent = FlightIntelligenceAgent()
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        """
        Handle incoming flight query tasks.
        """
        logger.info(f"Processing flight task: {request.params.id}")
        ...
        # Ask the agent for flight information
